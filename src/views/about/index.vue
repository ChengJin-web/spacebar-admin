<template>
  <div>
    <div class="card mb10">
      ...
      <span class="text">
        <el-link type="primary" href="https://docs.spacebar.top" target="_blank">Spacebar</el-link>
    ...
    <div class="card mb10">
      ...
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="Gitee" label-align="left">
          <el-link type="primary" href="https://gitee.com/chengkoi/Spacebar" target="_blank"> Gitee </el-link>
        </el-descriptions-item>
        <el-descriptions-item label="Github" label-align="left">
          <el-link type="primary" href="https://github.com/chengkoi/Spacebar" target="_blank"> Github </el-link>
        </el-descriptions-item>
        <el-descriptions-item label="文档地址" label-align="left">
          <el-link type="primary" href="https://docs.spacebar.top" target="_blank"> 文档地址 </el-link>
        </el-descriptions-item>
        <el-descriptions-item label="预览地址" label-align="left">
          <el-link type="primary" href="https://admin.spacebar.top" target="_blank"> 预览地址 </el-link>
        </el-descriptions-item>
      </el-descriptions>
    </div>
    <div class="card mb10">
