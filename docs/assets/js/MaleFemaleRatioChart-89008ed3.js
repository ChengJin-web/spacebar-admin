                ...
                series: [
                  {
                    ...
                    data: [a.man],
                    z: 20,
                    itemStyle: { borderRadius: 10, color: "#007AFE" },
                    label: {
                      show: !0,
                      color: "#E7E8ED",
                      position: "insideLeft",
                  ...
                  },
                  {
                    ...
                    data: [1],
                    barGap: "-100%",
                    itemStyle: { borderRadius: 10, color: "#FF4B7A" },
                    label: {
                      show: !0,
                      color: "#E7E8ED",
                      ...
                      offset: [0, -20],
                      fontSize: 12,
                      formatter: () => `女士 ${a.woman * 100}%`,
                    },
                  },
                ],
              };
            return e.setOption(i), e;
          },
        }),
        (a, t) => (n(), l("div", p, h))
      );
...
const E = m(w, [["__scopeId", "data-v-f715a496"]]);
export { E as default };
