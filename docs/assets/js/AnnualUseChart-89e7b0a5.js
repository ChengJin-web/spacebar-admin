...
import { d, o as p, c as m } from "./index-6d941592.js";
import { _ as h } from "./plugin-vue_export-helper-c27b6911.js";
const u = { id: "AnnualUseChart", class: "echarts" },
  f = d({
    ...
    setup(y, { expose: n }) {
      return (
        n({
          initChart: (t = {}) => {
            const r = document.getElementById("AnnualUseChart"),
              l = [
          ...
          <div class="year-item">
            ...
            <span class="year-value">${
              a.data >= 1e4 ? (a.data / 1e4).toFixed(2) + "w" : a.data
            }</span>
          </div>
          `;
                      }),
                ...
                yAxis: {
                  ...
                  axisLabel: {
                    ...
                    padding: 0,
                    formatter: function (e) {
                      return e >= 1e4 && (e = e / 1e4 + "w"), e;
                    },
                  },
                  axisTick: { show: !1 },
                },
                series: t.data.map((e, o) => ({
                  name: e.label,
                  type: "line",
                  symbol: "circle",
                  showSymbol: !1,
...
const C = h(f, [["__scopeId", "data-v-c35c1c51"]]);
export { C as default };
